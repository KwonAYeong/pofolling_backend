...
public class ChatRoomController {
    ...
    public ResponseEntity<ChatRoomResponseDTO> deactivateChatRoom (@PathVariable Long chatRoomId) {
        ChatRoomResponseDTO updatedRoom = chatRoomService.deactivateChatRoom(chatRoomId);
